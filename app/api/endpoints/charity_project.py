...
@router.post(
    ...
    summary="Создание нового благотворительного проекта (только суперюзеры)",
)
...
@router.patch(
    ...
    response_model=CharityProjectDB,
    dependencies=[Depends(current_superuser)],
    summary="Обновление данных благотворительного проекта (только суперюзеры)",
)
...
@router.delete(
    ...
    response_model=CharityProjectDB,
    dependencies=[Depends(current_superuser)],
    summary="Удление благотворительного проекта (только суперюзеры)",
)
